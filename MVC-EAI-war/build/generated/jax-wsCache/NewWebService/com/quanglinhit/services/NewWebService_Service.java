 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://service.quanglinhit.com/", wsdlLocation = "http://localhost:8080/MVC-EAI-war/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://service.quanglinhit.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MVC-EAI-war/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://service.quanglinhit.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.quanglinhit.com/", "NewWebServicePort"), NewWebService.class, features);
    }
